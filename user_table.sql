...
CREATE TABLE `user_table` (
  ...
  `u_acco` varchar(12) NOT NULL,
  `u_brith` varchar(7) NOT NULL,
  `u_email` varchar(40) NOT NULL,
  `u_pw` char(40) NOT NULL,
  `u_tel` varchar(25) NOT NULL,
...
INSERT INTO `user_table` (`u_id`, `u_name`, `u_acco`, `u_brith`, `u_email`, `u_pw`, `u_tel`, `address`) VALUES
